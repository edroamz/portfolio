    ...
    >
      <div className="md:w-full flex flex-col md:flex-row items-baseline justify-between md:gap-x-12 lg:gap-x-14 py-6 md:py-7 hover:bg-grey-50 dark:hover:bg-grey-930 hover:transition-none rounded-md md:rounded-xl px-7">
        <div className="w-full flex flex-row md:hidden items-center gap-x-2 mb-1 md:mb-0">
          ...
          <span className="inline-flex items-center uppercase text-xs text-grey-600 dark:text-grey-300">
          ...
          <span className="inline-block uppercase text-xs text-grey-600 dark:text-grey-300">
            {readingTime}
          </span>
        </div>
        <div className="h-full hidden md:inline-block w-full md:basis-1/5 uppercase text-sm text-grey-600 dark:text-grey-300 pl-3 md:pl-0 mb-4 md:mb-0 break-words">
          <span>
            <TimeFormatter dateString={datePublished}></TimeFormatter>
          </span>
        </div>
        <div className="h-full w-full md:basis-4/5">
          <span className="hidden md:inline-block uppercase text-sm text-grey-600 dark:text-grey-300 mb-2">
            {readingTime}
          </span>
